        ...
        <div className="relative flex items-center justify-between h-full flex-row-reverse">
          ...
          >
            {dark ? (
              ...
              <Moon className="w-5 h-5 text-dodger-200" />
            )}
          </button>
          ...
          <div className="flex items-center gap-6 justify-center md:justify-end flex-1 h-full">
            ...
            >
              ...
              <div className="hidden sm:flex flex-col text-right">
                ...
                <span className="text-xs text-dodger-200 font-ibm">
                  خبير مادة الرياضيات
                </span>
            ...
            <div className="hidden md:flex items-center gap-1 mr-6 font-ibm text-sm font-bold">
              ...
              >
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-3.5 h-3.5 transition-transform ${lessonsMenuOpen
                        ? 'rotate-180'
                        : ''
                      }`}
                  />
              ...
              <Link
                to="/books"
                className={`px-4 py-2 rounded-xl transition flex items-center gap-1.5 ${isBooksActive
                    ? 'bg-white/15 text-white shadow-inner'
                    : 'text-dodger-100 hover:bg-white/10 hover:text-white'
                  }`}
              >
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <ChevronDown
                  className={`w-4 h-4 transition-transform ${mobileLessonsOpen
                      ? 'rotate-180'
                      : ''
                    }`}
                />
            ...
            <Link
              to="/books"
              className={`px-4 py-2.5 rounded-xl text-sm font-bold flex items-center gap-2 transition ${isBooksActive
